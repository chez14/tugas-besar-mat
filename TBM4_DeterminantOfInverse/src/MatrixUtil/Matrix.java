...
public class Matrix {
     ...
     *
     * @param skalar skalar number that will be used to multiply the matrix
     */
     ...
     *
     * @param skalar skalar number that used to add the matrix
     */
     ...
     *
     * @param skalar skalar number that used to substract the matrix
     */
     ...
     *
     * @param skalar skalar number that used to divide the matrix.
     */
    ...
    private Matrix getSubmatrix(int m, int n) {
        if (matrix.length == 1) {
            return new Matrix(new double[][]{{matrix[0][0]}});
        }
     ...
     * @throws InvalidMoveException When the matrix are not n x n, this method
     * will throw an invalid move exception.
     */
     ...
     *
     * @return determinant
     * @throws InvalidMoveException When the matrix are not n x n, the matrix's
     * determinant cannot be determined.
     */
     ...
     * @throws InvalidMoveException On singular matrix, we couldn't find the
     * inverse of this matrix. So current process cannot be done, and throwing
     * an InvalidMoveException instead.
     */
