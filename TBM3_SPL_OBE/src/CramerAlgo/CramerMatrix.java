...
/**
 * Kelompok: Skywrath_Mage Program : SPL OBE
 *
...
public class CramerMatrix extends MatrixUtil.Matrix {
     ...
     *
     * @param colNum column number, or we can say the variable's index.
     ...
     * @throws InvalidMoveException When the matrix are not square or it's
     * determinant are 0, This exception will be thrown.
