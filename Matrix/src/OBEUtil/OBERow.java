...
/**
 * The OBE Class
 * This class are representate the row of the OBE operation.
 * Class has automation on how to resort them and such.
 * 
...
public class OBERow {
	 ...
	 */
	public void substract(OBERow subtractor) {
		this.substract(subtractor, 1);
	}
	 ...
	 *            subtraction held.
	 */
	public void substract(OBERow substractor, double scalar) {
		requireRedetect = true;
		for (int i = 0; i < col.length; i++)
	 ...
	 * @param value value of the new constant.
	 */
